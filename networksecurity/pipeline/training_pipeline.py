...
class TrainingPipeline:
    ...
    def start_data_transformation(self,data_validation_artifacat:DataValidationArtifact)->DataTransformationArtifact:
        try:
            data_transformation_config=DataTransformationConfig(training_pipeline_config=self.training_pipeline_config)
            logging.info("Start Data Transformation.")
            data_transformation=DataTransformation(data_validation_artifacat=data_validation_artifacat, data_transformation_config=data_transformation_config)
            data_transformation_artifact=data_transformation.initiate_data_transformation()
            logging.info(f"Data validation completed & artifact: {data_transformation_artifact}")
